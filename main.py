...
root['bg'] = 'yellow' # Set background color
root.title('Real-time Language Translator') # Set window title

# Create a label for the title
Label(root, text="Language Translator", font="Arial 20 bold", bg='yellow').pack()

# Create a label for the input text
Label(root, text="Input Text", font='arial 13 bold', bg='yellow').place(x=165, y=90)
...
Label(root, text="Translated Text", font='arial 13 bold', bg='yellow').place(x=780, y=90)
...
dest_lang.place(x=600, y=250)
dest_lang.set('Choose Destination Language') # Set default value
